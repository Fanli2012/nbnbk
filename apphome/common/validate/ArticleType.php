...
class ArticleType extends Validate
{
    ...
    protected $rule = [
        ...
        ['filename', 'require|max:30|alphaNum','别名必填|别名不能超过30个字符|别名格式不正确'],
        ['templist', 'max:50|alphaNum','列表页模板不能超过50个字符|列表页模板格式不正确'],
        ['temparticle', 'max:50|alphaNum','文章页模板不能超过50个字符|文章页模板格式不正确'],
    ...
    protected $scene = [
        'add'  => ['parent_id', 'name', 'seotitle', 'keywords', 'description', 'filename', 'templist', 'temparticle', 'litpic', 'is_part', 'listorder', 'add_time'],
        'edit' => ['parent_id', 'name', 'seotitle', 'keywords', 'description', 'filename', 'templist', 'temparticle', 'litpic', 'is_part', 'listorder', 'add_time'],
        'del'  => ['id'],
    ];
}