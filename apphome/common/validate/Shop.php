...
class Shop extends Validate
{
    ...
    protected $rule = [
        ...
        ['smscode', 'require|checkSmsCode','邮箱验证码必填'],
    ...
    {
        $verifyCode = model('EmailVerifyCode')->isVerify($data['email'], $value, $data['smstype']);
		if(!$verifyCode)
		{
			return '短信验证码不正确或已过期';
		}
