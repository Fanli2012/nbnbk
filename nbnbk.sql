...
insert  into `fl_tagindex`(`id`,`tag`,`title`,`description`,`content`,`pubdate`,`keywords`,`click`,`litpic`,`template`,`filename`,`ischeck`,`showmode`) values (1,'百度','百度title','','',1493047746,'',319,'','tag3','baidu',0,0),(2,'腾讯','腾讯title','','',1487685189,'',480,'','tag','qq',0,0),(3,'阿里巴巴','阿里巴巴title','','',1487685125,'',249,'','tag','ali',0,0);
