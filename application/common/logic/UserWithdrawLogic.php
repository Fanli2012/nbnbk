...
class UserWithdrawLogic extends BaseLogic
{
    ...
    public function add($data = array(), $type=0)
    {
		...
		{
			if(!(isset($data['bank_name']) && !empty($data['bank_name']))){return ReturnData::create(ReturnData::PARAMS_ERROR, null, '银行名称必填');}
			if(!(isset($data['bank_place']) && !empty($data['bank_place']))){return ReturnData::create(ReturnData::PARAMS_ERROR, null, '开户行必填');}
		}
